...
export default function DiscussionChat() {
  ...
  return (
    <section className="px-4 py-8 max-w-3xl mx-auto h-[80vh] flex flex-col">
      <motion.h2
          ...
          >
            ...
            >
              ...
              <div className="flex gap-3 mt-2">
                ...
                >
                  <ThumbsUp size={16} className="inline" /> {msg.reactions.like}
                </button>
                <button
                  onClick={() => handleReaction(msg.id, "heart")}
                  className="text-sm hover:text-pink-500"
                >
                  <Heart size={16} className="inline" /> {msg.reactions.heart}
                </button>
                <button
                  onClick={() => handleReaction(msg.id, "fire")}
                  className="text-sm hover:text-red-500"
                >
                  <Flame size={16} className="inline" /> {msg.reactions.fire}
                </button>
              </div>
            </div>
          </motion.div>
